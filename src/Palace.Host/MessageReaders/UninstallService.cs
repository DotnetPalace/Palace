    ...
    : ArianeBus.MessageReaderBase<Palace.Shared.Messages.UnInstallService>
{
    ...
    public override Task ProcessMessageAsync(UnInstallService message, CancellationToken cancellationToken)
    {
        if (message is null)
        {
    ...
    async Task ProcessMessageInternal(UnInstallService message, CancellationToken cancellationToken)
    {
