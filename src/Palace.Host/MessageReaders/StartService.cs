    ...
    : ArianeBus.MessageReaderBase<Shared.Messages.StartService>
{
    ...
    public override Task ProcessMessageAsync(Shared.Messages.StartService message, CancellationToken cancellationToken)
    {
        if (message is null)
        {
    ...
    async Task ProcessMessageInternal(Shared.Messages.StartService message, CancellationToken cancellationToken)
    {
